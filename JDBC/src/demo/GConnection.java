...
public class GConnection {
	...
	public static Connection getConnection() throws Exception {
		...
		/*
		 * classDriver = pro.getProperty("classDriver"); url =
		 * pro.getProperty("url"); userName = pro.getProperty("userName");
		...
		Connection conn = DriverManager
				.getConnection("jdbc:oracle:thin:@192.168.234.1:1521:orcl",
						"cjcbhb", "cjcbhb");
		return conn;
